...
df_con_doble = load_df("Experiment_con_doble_correciones_150/exp_con_dob_cor_25_128_150/pareto_25_128.csv")
...
plot_pareto_lines(df_sin, 'blue', r'No end-correction')
plot_pareto_lines(df_con, 'orange', r'With internal end-correction')
plot_pareto_lines(df_con_doble, 'green', r'With all the end-corrections')
...
plt.savefig(os.path.join(folder_name, "Pareto_con_sin_correciones_tre.png"))
